...
const projectId = process.env['2NYVonosv6PoDSw5WzqgLwmcsah'];
const projectSecretKey = process.env['6606ec4daf03765dd34bf1a51035cc86'];

const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://maryam-nft-marketplace.infura-ipfs.io";
